            ...
            <div class="col-lg-7 col-md-6">
                <div class="product-details-view-content pt-60">
                    <div class="product-info">
                        <h2 style="color: #FC5C31; font-weight: 700; font-size: 20px">{{ $product->TenDT}}</h2>
                        <span class="product-details-ref" style="font-size: 16px; color:black">Nhà sản xuất: {{ $product->supplier->TenNSX }}</span>
                        <div class="price-box pt-20">
                            <span class="new-price new-price-2">Giá:</span>
                    ...
                    <div class="product-details-comment-block">
                        <div class="review-btn">
                            @if(Auth::guard('customer')->check())
                                {{-- $emailKH = {EmailKH: Auth::guard('customer')->user()->email} --}}
                                @foreach($orders as $item)
                                    @if($item->EmailKH == Auth::guard('customer')->user()->email && $item->TrangThai == 1)
                        ...
                        <div class="row" id="feedbackSection">
                            ...
                            <div class="col-md-4 d-flex align-items-start">
                                <div>
                                    {{-- <img class="rounded-circle mr-5" src="https://picsum.photos/50/50" width="40"> --}}
                                    <img src="{{asset('public/frontend/images/ratinguser.png')}}" alt="rating" width="40" class="mr-10 rounded-circle">
                                </div>
                                <div>
                                <div class="comment-author-infos">
                                    <div style="font-size: 20px">{{ $fb->customer->name }}</div>
                                    <div class="comment-review">
                                        ...
                                        <span style="font-size: 12px; font-weight: 200; color: #b99696 ">{{ date('d-m-Y H:i:s', strtotime($fb->NgayTao)); }}</span>
                                </div>
                                <div class="comment-details">
                                    <h4 class="title-block">{{ $fb->BinhLuan }}</h4>
                                </div>
                                </div>
                            </div>
                            @endforeach
