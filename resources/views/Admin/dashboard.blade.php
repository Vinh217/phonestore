                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="" onclick="return OrderDetail('{{ $item->SoHDB }}',this,'{{ $item->payment_id }}')" role="button" data-toggle="modal" data-target="#modal-xl" class="btn btn-primary"><i class="fas fa-info"></i></a>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table">
                    <thead class="" style="background: #FC5C31; color: white">
                        <th>Tên</th>
                        <th>Màu</th>
                        <th>Số lượng</th>
                        <th>Đơn giá</th>
...
<script type="text/javascript">
    ...
    function OrderDetail(id, ctl, payment_id ) {
        const payment = payment_id ? 'Online' : 'Trực tiếp';
        $('#order_id').html("#" + id);
