...
class ProductController extends Controller
{
    ...
    public function getProductDetail($id)
    {
        ...
        $orders = DB::select('SELECT `order`.EmailKH, `order`.TrangThai FROM `order`,orderdetail WHERE `order`.SoHDB = orderdetail.SoHDB AND orderdetail.MaDT = :id', ['id' => $id]);
        // dd($orders);
        ...
        return view('Home.single-product', compact('product', 'feedback', 'other_product', 'orders'));
    }
